...
func Test_GenArgTableDto(t *testing.T) {
			...
			want: []argtabledtos.ArgTableDto{
				{
					...
					IsValue:         false,
					IsArg:           false,
					QuoteTypeSignal: argtables.QuoteType(argtables.NoQuote),
					UnkownOption:    "",
					Str:             nil,
				},
				{
					...
					IsValue:         true,
					IsArg:           true,
					QuoteTypeSignal: argtables.QuoteType(argtables.SingleQuote),
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := argtabledtos.GenArgTableDto(tt.input)
