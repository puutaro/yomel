	...
	tests := []struct {
		...
		},
		{
			...
			input: []argtables.ArgTable{
				...
				{No: 6, StageNo: 0, IsErrLogFilter: true},
				{No: 7, StageNo: 0, Str: testutil.Ptr("global-err-filter")},
				{No: 8, StageNo: 1, IsStage: true},
				{No: 9, StageNo: 1, Str: testutil.Ptr("stage-comprehensive")},
				{No: 10, StageNo: 1, IsNoLog: true},
				{No: 11, StageNo: 1, IsErrLogFilter: true},
				{No: 12, StageNo: 1, Str: testutil.Ptr("stage-err-filter")},
				{No: 13, StageNo: 1, IsCmd: true},
				{No: 14, StageNo: 1, Str: testutil.Ptr("aws")},
				{No: 15, StageNo: 1, IsLopt: true},
				{No: 16, StageNo: 1, Str: testutil.Ptr("profile")},
				{No: 17, StageNo: 1, IsSvc: true},
				{No: 18, StageNo: 1, Str: testutil.Ptr("s3")},
				{No: 19, StageNo: 1, IsOpt: true},
				{No: 20, StageNo: 1, Str: testutil.Ptr("r")},
				{No: 21, StageNo: 1, IsAct: true},
				{No: 22, StageNo: 1, Str: testutil.Ptr("cp")},
				{No: 23, StageNo: 1, IsLopt: true},
				{No: 24, StageNo: 1, Str: testutil.Ptr("recursive")},
				{No: 25, StageNo: 1, IsArg: true},
				{No: 26, StageNo: 1, QuoteTypeSignal: argtabledtos.SingleQuote},
				{No: 27, StageNo: 1, Str: testutil.Ptr("arg-val")},
			},
			wantCtrl: ControlModel{
				IsVersion:    true,
				IsHelp:       true,
