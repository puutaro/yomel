...
func Test_getFlag(t *testing.T) {
	tests := []struct {
		...
		input          []argtabledtos.ArgTableDto          // Slice of input arguments
		isCheckFn      func(argtabledtos.ArgTableDto) bool // Condition check function
	...
	}{
		{
			...
			isCheckFn:   func(t argtabledtos.ArgTableDto) bool { return t.IsLog },
			defaultBool: false,
			want:        true,
		},
		{
