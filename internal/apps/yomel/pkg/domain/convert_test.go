			...
			inputSts: []model.StageModel{
				{
					...
					Svc:       testutil.Ptr("s3"),
					Act:       testutil.Ptr("cp"),
					ActLops:   []model.OptParam{{Index: 5, OptStr: "region", Param: model.ParamType{Str: testutil.Ptr("us-east-1"), QuoteType: argtables.SingleQuote}}},
			...
			inputSts: []model.StageModel{
				{
					...
					Cmd:          "aws",
					CmdLops:      []model.OptParam{{Index: 1, OptStr: "profile", Param: model.ParamType{Str: testutil.Ptr("prod"), QuoteType: argtables.NoQuote}}},
					CmdArgs:      []model.ArgParam{{Index: 2, Param: model.ParamType{Str: testutil.Ptr("cmd-arg"), QuoteType: argtables.DoubleQuote}}},
					Svc:          testutil.Ptr("s3"),
					SvcOps:       []model.OptParam{{Index: 3, OptStr: "r", Param: model.ParamType{}}},
					SvcLops:      []model.OptParam{{Index: 4, OptStr: "svc-lop", Param: model.ParamType{Str: testutil.Ptr("val"), QuoteType: argtables.SingleQuote}}},
					SvcArgs:      []model.ArgParam{{Index: 5, Param: model.ParamType{Str: testutil.Ptr("svc-arg"), QuoteType: argtables.NoQuote}}},
					Act:          testutil.Ptr("cp"),
					...
					ActArgs:      []model.ArgParam{{Index: 8, Param: model.ParamType{Str: testutil.Ptr("act-arg"), QuoteType: argtables.NoQuote}}},
